...
import cv2
import os, glob
from src.dataset.image_translation.image_translation_dataset import vis_landmark_on_img, vis_landmark_on_img98, \
    vis_landmark_on_img74
...
class Image_translation_block():
        ...
        if (not single_test):
            ...
            if (opt_parser.use_vox_dataset == 'raw'):
                if (opt_parser.comb_fan_awing):
                    ...
                    from src.dataset.image_translation.image_translation_dataset import \
                        image_translation_raw98_with_audio_dataset as \
                            image_translation_dataset
                else:
                    from src.dataset.image_translation.image_translation_dataset import \
                        image_translation_raw98_dataset as \
                            image_translation_dataset
            else:
                from src.dataset.image_translation.image_translation_dataset import \
                    image_translation_preprocessed98_dataset as \
                        image_translation_dataset
    ...
    def test(self):
        if (self.opt_parser.use_vox_dataset == 'raw'):
            if (self.opt_parser.add_audio_in):
                ...
                from src.dataset.image_translation.image_translation_dataset import \
                    image_translation_raw98_test_dataset as image_translation_test_dataset
        else:
            from src.dataset.image_translation.image_translation_dataset import \
                image_translation_preprocessed98_test_dataset as image_translation_test_dataset
    ...
    def single_test(self, jpg=None, fls=None, filename=None, prefix='', grey_only=False):
        ...
        return np.concatenate(video, axis=0)
